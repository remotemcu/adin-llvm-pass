...
; CHECK-LABEL: @f(
; CHECK:  call void @__adin_store_(i8* inttoptr (i64 256 to i8*), i64 1, i32 32, i32 4)
; CHECK-NEXT:  %load_i32_ = call i64 @__adin_load_(i8* inttoptr (i64 256 to i8*), i32 32, i32 4)
; CHECK-NEXT:  %truncated_i32_ = trunc i64 %load_i32_ to i32
; CHECK-NEXT:  store i32 %truncated_i32_, i32* %1, align 4
; CHECK-NEXT:  %load_i32_1 = call i64 @__adin_load_(i8* inttoptr (i64 256 to i8*), i32 32, i32 4)
; CHECK-NEXT:  %truncated_i32_2 = trunc i64 %load_i32_1 to i32
; CHECK-NEXT:  %cast_Val_i32__to_i64_ = zext i32 %truncated_i32_2 to i64
; CHECK-NEXT:  call void @__adin_store_(i8* bitcast (i32* @b to i8*), i64 %cast_Val_i32__to_i64_, i32 32, i32 4)
  ret void
}
