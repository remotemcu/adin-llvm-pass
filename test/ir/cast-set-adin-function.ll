...
; CHECK-NEXT:  %2 = call i32 @_load_(i8* inttoptr (i64 256 to i8*), i32 32, i32 4)
; CHECK-NEXT:  store i32 %2, i32* %1, align 4
; CHECK-NEXT:  %3 = call i32 @_load_(i8* inttoptr (i64 256 to i8*), i32 32, i32 4)
; CHECK-NEXT:  call void @_store_(i8* bitcast (i32* @b to i8*), i32 %3, i32 32, i32 4)
  ret void
}
